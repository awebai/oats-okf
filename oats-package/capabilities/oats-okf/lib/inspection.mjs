...
export function sourceAuthority(source) {
  return {schemaVersion:1,registration:'legacy',capture:'recorded',migrationRequired:false};
}
export const capturedAuthority = sourceAuthority;
export function inspect(source) {
  ...
  return {
    ...
    source:source.file,owns:source.decl.owns,reads:source.decl.reads,bases:source.bindings.bases,authority:sourceAuthority(source),
